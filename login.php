<?php 
session_start();//Guarda la información
if($_POST){
  include("./bd.php");
  $sentencia = $conexion->prepare("SELECT *,count(*) as n_usuarios FROM `tbl_empleados` WHERE usuario=:usuario AND password=:password");
  ...
  if($registro["n_usuarios"]>0){
    ...
    $_SESSION['puesto'] = $registro["idpuesto"];
